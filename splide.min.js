...
t = function() {
    ...
    var Vn = "role"
      ...
      , et = "fade";
    function ct(u, r, i, o) {
        var e, n = En(u), c = n.on, f = n.emit, a = n.bind, t = n.destroy, s = u.Components, l = u.root, d = u.options, v = d.isNavigation, h = d.updateOnMove, p = s.Direction.resolve, g = X(o, "style"), m = -1 < i, y = S(o, "." + Fn), w = d.focusableNodes && J(o, d.focusableNodes);
        function _() {
            var n;
            e || (n = u.index,
            b.call(this, x()),
        ...
        return {
            ...
            isWithin: function(n, t) {
                return n = un(n - r),
                (n = !m && (d.rewind || u.is(ot)) ? $(n, u.length - n) : n) <= t
            }
        }
    }
    ...
    var pt = Object.freeze({
        ...
        Slides: function(r, u, o) {
            ...
            return {
                ...
                add: function(n, u) {
                    w(n, function(n) {
                        var t, i, r;
                        C(n = P(n) ? Y(n) : n) && ((t = f[u]) ? E(n, t) : L(a, n),
                        A(n, o.classes.slide),
                        n = n,
                        i = e.bind(null, xn),
                        n = J(n, "img"),
        ...
        Layout: function(n, t, i) {
            ...
            function v() {
                r = "ttb" === i.direction,
                I(n.root, "maxWidth", V(i.width)),
                I(s, a("paddingLeft"), p(!1)),
                I(s, a("paddingRight"), p(!0)),
                h()
            }
            function h() {
                I(s, "height", function() {
        ...
        Clones: function(c, n, f) {
            ...
            function p() {
                ...
                P(t = f[o("fixedWidth")]) && (t = G(n = F("div", {
        ...
        Move: function(c, f, a) {
            ...
            function g() {
                s || f.Drag.isDragging() || (f.Scroll.cancel(),
                m(c.index),
                l(An))
            }
            function m(n) {
        ...
        Arrows: function(u, n, i) {
            ...
            function g() {
                ...
                r = !0,
                L(d, [v, h]),
                E(d, S("slider" === i.arrows && s.slider || u.root)))),
                v && h && (p.prev ? j(d, !1 === i.arrows ? "none" : "") : (n = s.track.id,
                T(v, Qn, n),
                T(h, Qn, n),
                p.prev = v,
                p.next = h,
        ...
        Drag: function(r, u, o) {
            var e, c, f, a, s, l, d, v, h, n = En(r), t = n.on, p = n.emit, g = n.bind, m = n.unbind, y = u.Move, w = u.Scroll, _ = u.Controller, b = u.Elements.track, i = (n = u.Direction).resolve, x = n.orient, k = y.getPosition, A = y.exceededLimit, L = {
                passive: !1,
                capture: !0
            }, E = !1;
            function z() {
            ...
            function S(n) {
                ...
                v || (t = o.noDrag,
                i = I(n),
                !(!t || C(n.target) && !N(n.target, t)) || !i && n.button || (y.isBusy() ? U(n, !0) : (h = i ? b : window,
                a = f = null,
                d = !1,
                g(h, ft, R, L),
                g(h, at, D, L),
            ...
            function R(n) {
                ...
                i = E !== (E = A()),
                (t || i) && P(n),
                y.translate(e + (T(n) - T(c)) / (E && r.is(ut) ? 5 : 1)),
                p("dragging"),
                d = !0,
                U(n)) : (t = un(T(n) - T(c)),
            ...
            function D(n) {
                ...
                s ? _.scroll(i) : r.is(et) ? _.go(r.index + x(cn(t))) : _.go(_.toDest(i), !0),
                U(n)),
                p("dragged")),
                l = !1
            }
        ...
        Keyboard: function(t, n, i) {
            ...
            function s() {
                var n = i.keyboard
                  , n = void 0 === n ? "global" : n;
                n && ("focused" === n ? T(r = f, tt, 0) : r = window,
                e(r, "keydown", d))
            }
            function l() {
                c(r, "keydown"),
                    ...
                    o.lazyLoad && (r([ln, _n], function() {
                        ...
                        n.Slides.forEach(function(u) {
                            J(u.slide, vt).forEach(function(n) {
                                ...
                                i === n.src && r === n.srcset || (T(t = F("span", o.classes.spinner, n.parentElement), Vn, "presentation"),
                                a.push({
                                    e: n,
                                    o: u,
                                    src: i,
